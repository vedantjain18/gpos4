...
const PurchaseChallanEntry = () => {
    return (

        <div className="container mt-3">
    <h4 className="alert alert-info text-center mb-1 p-1"> Purchase Challan (SCAN POS) </h4>
    <div className="row">
    ...
    <form className="" id="logout" method="post" action="../loginauth/logout.php">
            ...
            <form className="col-sm-12" id="distinfo" method="post" action="">
                ...
                <input type="text" className="form-control" id="purbillno" name="purbillno" placeholder="Challan No." required/>
            ...
            <form className="col-sm-12" id="savebtn" method="post" action="">
                ...
                <button type="submit" className="btn btn-info" id="btnsave">SAVE PURCHASE CHALLAN</button>
            </form>
  ...
  export default PurchaseChallanEntry