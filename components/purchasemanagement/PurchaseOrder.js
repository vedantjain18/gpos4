...
const PurchaseOrder = () => {
    ...
    <h4 className="alert alert-info text-center mb-1 p-1"> Purchase Order (SCAN POS) </h4>
    <div className="row">
    ...
    <form className="" id="logout" method="post" action="../loginauth/logout.php">
            ...
            <form className="col-sm-12" id="distinfo" method="post" action="">
                ...
                <input type="text" className="form-control" id="purbillno" name="purbillno" placeholder="Order No." required/>
