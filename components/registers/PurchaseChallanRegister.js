...
const PurchaseChallanRegister = () => {
    return (

        <div className="container mt-3">
    <h4 className="alert alert-info text-center mb-1 p-1"> Purchase Challan Register </h4>
    <div className="row">
  ...
  export default PurchaseChallanRegister